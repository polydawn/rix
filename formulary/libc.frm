...
action:
	command:
		...
		- |
			...
			#configureOpts+=("--libdir=/task/include/")
			configureOpts+=("--enable-obsolete-rpc")
			...
			configureOpts+=("libc_cv_forced_unwind=yes")
			configureOpts+=("libc_cv_c_cleanup=yes")
...
outputs:
	"/task/build":
		type: "dir"
		silo: "file://./sigh-build/"
	"/task/output":
		tag: "libc-mess"
		type: "dir"
		silo: "file://./sigh-output/"
